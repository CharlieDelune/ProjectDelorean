...
public class SpriteSwapper : MonoBehaviour
{
    ...
    private Texture LoadedSpriteSheetName;
    ...
    private void Start()
    {
        ...
        //path = AssetDatabase.GetAssetPath(spriteSheetAsset);
    ...
    private void LateUpdate()
    {
        ...
        if (this.LoadedSpriteSheetName.name != this.spriteSheetAsset.name)
        {
